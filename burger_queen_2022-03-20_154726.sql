...
CREATE TABLE `ingredients` (
  ...
  `quantity_in_grams` decimal(10,4) DEFAULT '0.0000',
  PRIMARY KEY (`id`)
...
CREATE TABLE `orders` (
  ...
  `status` enum('order_recieved','on_process','served','completed','canceled') DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2022-03-20 15:47:32
